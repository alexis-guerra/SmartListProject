...
public class TinyDB {
    ...
    public ArrayList<Stores> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Stores> playerList =  new ArrayList<Stores>();

        for(String jObjString : objStrings){
            Stores player  = gson.fromJson(jObjString,  Stores.class);
    ...
    public void putListObject(String key, ArrayList<Stores> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Stores player: playerList){
